...
function App() {
  ...
  const getRPCContractProvider = () => {
    const RPC = "https://goerli.infura.io/v3/bd3283c53475479792ed8f68c398a0e9";
        ...
        <div id="main-wrap" className="main-wrap">
          <Routes>
            ...
            <Route
              ...
              path="/market"
              element={
                <Explore marketplace={marketContract} nft={nftContract} />
              }
            />
            <Route
              exact
            ...
            <Route
              ...
              path="/link"
              element={
                <Create marketplace={marketContract} nft={nftContract} />
              }
            />
            <Route
              exact
              path="/invite/:userAddress/:tokenID/:itemID"
              element={
                <Invite
                  marketplace={marketContract}
                  nft={nftContract}
